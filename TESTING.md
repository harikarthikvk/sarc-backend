...
```bash
SKIP THIS I DID IT ALREADY FOR YOU.
```
...
#Note: README AND TESTING pages are generated by AI. and Ai was used in bug finding in the code. Logic was written by me, USE of ai was to find things I thought i fixed but i didnt.
```
